...
- [x] 2.1 (a) SUPERSEDED by D5 (b): Finaliser obs migration deferred to follow-up change — NOT implemented this change
- [x] 2.2 (a) SUPERSEDED by D5 (b): no Tasker task-loop change — NOT implemented this change
- [x] 2.3 (a) SUPERSEDED by D5 (b): no Finaliser integration test this change
