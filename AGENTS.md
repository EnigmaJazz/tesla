...
`STALE_API_RESPONSE_DISCARDED`, `REDUCER_BATCH_DELIVERED`,
`BATCH_ENVELOPE_REJECTED`, `BATCH_SUBCOMMAND_REJECTED`, `OBS_BATCH_FLUSH_SKIPPED`,
`OBS_BATCH_TRUNCATED`, `OBS_BATCH_MERGED`. Free-form console output is not a
substitute.
